...
# Declare the folders for assets to be routed from
frontend_folder = os.path.join(os.getcwd(), '..', 'frontend')
dist_folder = os.path.join(frontend_folder, 'dist')

# Route for home and for other served files
@app.route("/")
def indexHome():
...
# Get connected to the MongoDB client (Username is "capstoneUser" and password is "7capstone7Pass7")
client = MongoClient('mongodb+srv://capstoneUser:7capstone7Pass7@capstone-cluster.awwwf.mongodb.net/?retryWrites=true&w=majority&appName=capstone-cluster')
db = client['LoginInfo']
